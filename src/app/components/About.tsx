...
export default function About({ activeTab = 'overview', onTabChange }: AboutProps) {
    ...
    const teamMembers = [
        ...
        { name: "Edward Champion", role: "", image: "/team/optimized/edward_champion.jpeg", bio: "", linkedin: "https://linkedin.com/in/edward-champion-1ab842156" },
        { name: "Alvaro Garcia", role: "RF Engineer", image: "/team/optimized/alvaro.jpeg", bio: "I'm a telecommunications enthusiast focused on the development of phased array antennas for satellite communications. At Satwave, I work across the antenna and RF design, enjoying the engineering culture and the team's passion for building antennas that empower global connectivity. When I am away from the office, I enjoy traveling and exploring new cities and food spots… and playing padel!", linkedin: "https://linkedin.com/in/alvaro-garciac" },
        ...
        { name: "Eric Walker", role: "", image: "/team/optimized/eric_walker.jpeg", bio: "", linkedin: "https://linkedin.com/in/erichwalker" },
    ];
