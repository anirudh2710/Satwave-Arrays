                ...
                <div className="flex flex-col gap-12 lg:gap-20">
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 lg:items-end lg:mt-6">
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-1/2 glass-card p-6 border-brand-black/20 flex flex-col"
                        >
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-1/2 flex flex-col items-start justify-start gap-8 glass-card p-6 border-brand-black/20"
                        >
                            <motion.p
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
