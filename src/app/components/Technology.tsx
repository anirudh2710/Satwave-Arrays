            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full py-12">
                <div className="flex flex-col gap-12 lg:gap-20">
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 lg:items-start">
                        ...
                        {/* Top Right: Empty Spacer for Desktop */}
                        <div className="hidden lg:block lg:w-1/2" />
                    </div>

                    {/* Bottom Row */}
                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 lg:items-end lg:mt-6">
                        {/* Bottom Left: Our Core Focus */}
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true, margin: "-50px" }}
                            transition={{ duration: 0.7, delay: 0.2 }}
                            className="w-full lg:w-1/2 glass-card p-6 border-brand-black/20 flex flex-col rounded-lg"
                        >
                            <h3 className="text-3xl font-bold text-white mb-4 uppercase tracking-wide">Our Core Focus</h3>
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-1/2 flex flex-col items-start justify-start gap-8 glass-card p-6 border-brand-black/20 rounded-lg"
                        >
                            <motion.p
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
