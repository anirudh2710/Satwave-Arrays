            ...
            <div className="relative z-10 w-full flex flex-col flex-grow">
                ...
                <div className="max-w-4xl mx-auto px-6 pt-32 pb-6 w-full">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                        {/* Back Button - Left */}
                        <Link href="/news" className="group inline-flex items-center text-white hover:bg-white/10 transition-all px-3 py-2 rounded-md self-start sm:self-auto">
                ...
                <article className="max-w-4xl mx-auto px-6 pb-12 w-full flex-grow">
                    ...
                    {/* Featured Image */}
                    <div className="aspect-video w-full rounded-lg overflow-hidden bg-gradient-to-br from-brand-black/20 to-white/20 mb-12 relative">
                        {article.mainImage ? (
                            <img
                    ...
                    prose-blockquote:border-l-white prose-blockquote:bg-white/5 prose-blockquote:py-2 prose-blockquote:px-4">
                    ...
                    <div className="mt-16 pt-8 border-t border-white/10">
                        <p className="text-gray-400 text-center">
                            For more information, please <Link href="/#contact" className="text-white hover:underline">contact us</Link>
                        </p>
                    </div>
                </article>
